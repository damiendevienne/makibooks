      ...
      {(manualMode || catalogBook) && <div className="book-editor-sections">
        <section className="book-editor-section">
          ...
          {catalogSelected ? <div className="catalog-book-summary">
            ...
            <div className="mb-3"><label className="form-label">Author *</label><input className="form-control" required value={form.author} onChange={(event) => update("author", event.target.value)} /><small className="text-muted d-block mt-1">Title and author cannot be edited after this book is created.</small></div>
